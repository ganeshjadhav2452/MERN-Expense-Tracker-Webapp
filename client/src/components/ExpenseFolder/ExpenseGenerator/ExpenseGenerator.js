    ...
    return (
        <div className='parent p-3'>
            ...
            <div className={` container d-flex align-items-center ${darkMode ? darkStyle : 'bg-warning '}  p-3 `} style={{ borderRadius: '0.5rem' }}>
                ...
                <div class="table-wrapper mr-3 w-75 d-flex flex-column align-items-center">
                ...
                <div className={` border  rounded   shadow w-25 d-flex flex-column align-items-center p-2 justify-content-center ${darkMode ? darkStyle + 'border-warning' : 'border-dark bg-light'}`} style={{ height: '14rem', boxShadow: '0px 35px 50px rgba( 0, 0, 0, 0.2 )' }}>
